...
namespace Tests {
    public class TesteCampeonato {
        ...
        public void Deve_Retornar_Ponto_ao_Adicionado_Ao_Time_Passado_Como_Parametro () {
            ...
            campeonato.AdicionarGolsAoJogo ("Santos", 2);
            campeonato.AdicionarGolsAoJogo ("Ituano", 2);
        ...
        public void Deve_Retornar_Tabela_De_Resultado_Com_Pontuações_GEradas_Automaticamente () {
            ...
            //Metodo criado no escopo gerador de jogadores
            var times = campeonato.AdicionarTimes (time, cbf);
            var tabelaResultadodasPartidas = campeonato.registrarPontuacoesDasPartidasAutomaticamente (cbf);
        ...
        public void Deve_Retornar_Resultado_Primeira_Rodada () {
            ...
            campeonato.AdicionarGolsAoJogo ("Flamengo", 1);
            campeonato.AdicionarGolsAoJogo ("Atletico", 0);
            campeonato.AdicionarGolsAoJogo ("Ituano", 1);
            campeonato.AdicionarGolsAoJogo ("Palmeiras", 0);
            campeonato.AdicionarGolsAoJogo ("Bahia", 1);
            campeonato.AdicionarGolsAoJogo ("Santos", 1);
            campeonato.AdicionarGolsAoJogo ("Jabaquara", 0);
            campeonato.AdicionarGolsAoJogo ("Portuguesa", 0);
